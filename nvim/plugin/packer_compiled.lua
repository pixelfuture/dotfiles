...
_G.packer_plugins = {
  ...
  catppuccin = {
    loaded = true,
    path = "/Users/rodrigomunoz/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["dressing.nvim"] = {
    loaded = true,
    path = "/Users/rodrigomunoz/.local/share/nvim/site/pack/packer/start/dressing.nvim",
  ...
  harpoon = {
    loaded = true,
    path = "/Users/rodrigomunoz/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/Users/rodrigomunoz/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
    url = "https://github.com/VonHeikemen/lsp-zero.nvim"
  },
  ["lualine.nvim"] = {
    loaded = true,
    path = "/Users/rodrigomunoz/.local/share/nvim/site/pack/packer/start/lualine.nvim",
  ...
  ["nvim-hlslens"] = {
    loaded = true,
    path = "/Users/rodrigomunoz/.local/share/nvim/site/pack/packer/start/nvim-hlslens",
  ...
  ["peek.nvim"] = {
    loaded = true,
    path = "/Users/rodrigomunoz/.local/share/nvim/site/pack/packer/start/peek.nvim",
    url = "https://github.com/toppair/peek.nvim"
  },
  playground = {
    loaded = true,
    path = "/Users/rodrigomunoz/.local/share/nvim/site/pack/packer/start/playground",
  ...
  undotree = {
    loaded = true,
    path = "/Users/rodrigomunoz/.local/share/nvim/site/pack/packer/start/undotree",
