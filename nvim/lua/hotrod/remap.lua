...
keymap.set("n", "<M-h>", function() win_move("h") end, { desc = "move to left window" })
keymap.set("n", "<M-j>", function() win_move("j") end, { desc = "move to down window" })
keymap.set("n", "<M-k>", function() win_move("k") end, { desc = "move to top window" })
keymap.set("n", "<M-l>", function() win_move("l") end, { desc = "move to right window" })
