...
vim.api.nvim_create_autocmd("BufEnter", { group = group, command = "setlocal formatoptions-=c formatoptions-=r formatoptions-=o" })

-- opens help in new tab
vim.api.nvim_create_autocmd("BufEnter", { pattern = { "*.txt" }, group = group, callback = function ()
...
-- highlight on yank
vim.api.nvim_create_autocmd("TextYankPost", { group = group, callback = function ()
...
vim.api.nvim_create_autocmd("BufEnter", { pattern = { "*.git/COMMIT_EDITMSG" }, group = git_group, callback = function ()
