...
-- dotfiles
map("<leader>en", "<cmd>lua require'config.telescope'.edit_neovim()<cr>")
map("<leader>es", "<cmd>lua require'config.telescope'.edit_scripts()<cr>")

-- files
map("<leader>ff", "<cmd>lua require('config.telescope').find_files()<cr>")
map("<leader>ft", "<cmd>lua require('config.telescope').fd()<cr>")
...
map("<leader>fz", "<cmd>lua require('config.telescope').current_buffer_fuzzy_find()<cr>")
...
map("<leader>fe", "<cmd>lua require('config.telescope').file_browser()<cr>")
