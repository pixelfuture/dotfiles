...
function M.build()
  ...
  local fnm = fn.expand '%:.'
  if fnm ~= '' then st = st .. '%#StatusFile# ' .. fnm .. ' ' .. (vim.bo.modified and ' ' or '') .. '%#StatusFileToNorm#' end
  ...
  st = st .. '%#StatusBuffer# ' .. vim.bo.fileencoding .. ' ' .. vim.bo.fileformat .. ' ' .. '%#StatusLocation# %l:%c ' .. '%#StatusPercent# %p%% '
